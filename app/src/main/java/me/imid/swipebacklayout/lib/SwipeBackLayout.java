...
import com.turlet.recyclerdemo.R;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    private void drawScrim(Canvas canvas, View child) {
        ...
        if ((mTrackingEdge & EDGE_LEFT) != 0) {
            ...
            canvas.clipRect(child.getLeft(), child.getTop(), getRight(), getHeight());
        }
    ...
    private void drawShadow(Canvas canvas, View child) {
        ...
        if ((mEdgeFlag & EDGE_TOP) != 0) {
            mShadowBottom.setBounds(childRect.left, childRect.top + mShadowBottom.getIntrinsicHeight(), childRect.right,
                    childRect.bottom);
            mShadowBottom.setAlpha((int) (mScrimOpacity * FULL_ALPHA));
            mShadowBottom.draw(canvas);
        }
